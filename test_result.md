...
user_problem_statement: "Посмотри мой Telegram Mini App - это отдельная версия приложения ,не веб версия с авторизацией через гугл ,а именно телеграмм приложение с автоиизацией через телеграмм ,а именно инструмент 'Поиск работы' ,выбивает вот такую ошибку ,так же города не выпадают из списка ,а так же сделай графу 'поиск по должности как дополнительную' ,чтобы было достаточно только города ,уровня немецкого"
